        ...
        <div class="card-body">
          ...
          ${this.stage==="config"?g`
                ...
                <label class="field">
                  ...
                  <select
                    .value=${this.chipName}
                    @change=${t=>{this.chipName=t.target.value}}
                    ?disabled=${this.loadingChips||this.chips.length===0}
                  >
                    ${this.loadingChips?g`<option value="">Loading chips…</option>`:this.chips.map(t=>g`<option value=${t.chip_name} ?selected=${t.chip_name===this.chipName}>
                            ${t.chip_name} — ${t.board}
                          </option>`)}
                  </select>
                  <small class="hint"
          ...
          ${this.stage==="compiling"?g`
                <div class="status">
                  ...
                  <div>
                    <strong
                      >Compiling ${this.esphomeName}…${this.compilePercent>0?` ${this.compilePercent}%`:""}</strong
                    >
...
.badge.loading {
  ...
  `;Ft([v()],lt.prototype,"route",2);Ft([v()],lt.prototype,"queueData",2);Ft([v()],lt.prototype,"compileData",2);Ft([v()],lt.prototype,"addonConnected",2);Ft([v()],lt.prototype,"bridgeConnected",2);Ft([v()],lt.prototype,"bridgeConfigured",2);Ft([v()],lt.prototype,"integrationLoaded",2);Ft([v()],lt.prototype,"integrationConfigured",2);Ft([v()],lt.prototype,"restartRequired",2);lt=Ft([ke("espnow-app")],lt);
//# sourceMappingURL=index-DStJm1bP.js.map
