 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Ri=globalThis;let he=class extends Ji{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){var i;const e=super.createRenderRoot();return(i=this.renderOptions).renderBefore??(i.renderBefore=e.firstChild),e}update(e){const i=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=lg(i,this.renderRoot,this.renderOptions)}connectedCallback(){var e;super.connectedCallback(),(e=this._$Do)==null||e.setConnected(!0)}disconnectedCallback(){var e;super.disconnectedCallback(),(e=this._$Do)==null||e.setConnected(!1)}render(){return ps}};var kd;he._$litElement$=!0,he.finalized=!0,(kd=Ri.litElementHydrateSupport)==null||kd.call(Ri,{LitElement:he});const vo=Ri.litElementPolyfillSupport;vo==null||vo({LitElement:he});(Ri.litElementVersions??(Ri.litElementVersions=[])).push("4.2.2");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 */function Pd(t,e){return(i,s,r)=>{const n=o=>{var a;return((a=o.renderRoot)==null?void 0:a.querySelector(t))??null};return dg(i,s,{get(){return n(this)}})}}const fg=(()=>{const t=document.querySelector('meta[name="x-ingress-path"]');return t&&t.getAttribute("content")?t.getAttribute("content").replace(/\/+$/,""):""})(),ug=15e3,pg=3e4;let Er=null,yo=null;function zt(t){const e=fg||"";return t.startsWith("/")?e+t:e+"/"+t}function gg(t,e){if(!t)return null;if(e!=null&&e.includes("application/json"))return JSON.parse(t);try{return JSON.parse(t)}catch{return t}}async function M(t,e){const i=new AbortController,s=setTimeout(()=>i.abort("timeout"),ug);try{const r=await fetch(zt(t),{...e,signal:i.signal,headers:(e==null?void 0:e.body)instanceof FormData?e.headers:{"Content-Type":"application/json",...(e==null?void 0:e.headers)||{}}});clearTimeout(s);const n=await r.text(),o=gg(n,r.headers.get("content-type"));if(!r.ok){let a=`${r.status} ${r.statusText}`;if(o&&typeof o=="object"){const l=o,c=l.detail,h=l.error;typeof c=="string"&&c?a=c:typeof h=="string"&&h&&(a=h)}else typeof o=="string"&&o&&(a=o);throw new Error(a)}return o}catch(r){if(clearTimeout(s),r instanceof DOMException&&r.name==="AbortError"){const n=i.signal.reason;throw new Error(n==="timeout"?"timeout":"cancelled")}throw r}}const S={config:()=>M("/api/config"),updateConfig:t=>M("/api/config",{method:"PUT",body:JSON.stringify(t)}),discoverBridges:()=>M("/api/bridge/discover").then(t=>Array.isArray(t)?{bridges:t,scanning:!0}:{bridges:t.bridges??[],scanning:!!t.scanning}),triggerScan:()=>M("/api/bridge/scan",{method:"POST"}),getScanLog:()=>M("/api/bridge/scan-log"),getBridges:()=>M("/api/bridges"),scanSerialPorts:()=>M("/api/serial/ports").then(t=>t.ports),addBridge:(t,e=80,i,s,r,n="wifi",o,a=460800)=>M("/api/bridges",{method:"POST",body:JSON.stringify({host:t,port:e,name:i,api_key:s,hostname:r,transport:n,serial_port:o,baud:a})}),updateBridge:(t,e,i,s,r)=>M(`/api/bridges/${t}`,{method:"PUT",body:JSON.stringify({name:e,host:i,port:s,api_key:r})}),deleteBridge:t=>M(`/api/bridges/${t}`,{method:"DELETE"}),activateBridge:t=>M(`/api/bridges/${t}/activate`,{method:"PUT"}),deactivateBridge:t=>M(`/api/bridges/${t}/deactivate`,{method:"PUT"}),bridgeReconnect:t=>M(`/api/bridges/${t}/reconnect`,{method:"POST"}),selectBridge:(t,e,i,s,r,n,o)=>M("/api/bridge/select",{method:"POST",body:JSON.stringify({host:t,port:e,name:i,version:s,api_key:r,network_id:n,hostname:o})}),topology:(t=!1)=>{const e=Date.now();return!t&&Er&&e-Er.ts<pg?Promise.resolve(Er.data):M("/api/bridge/topology.json").then(i=>(Er={data:i,ts:e},i))},hideDevice:t=>M(`/api/topology/hide/${encodeURIComponent(t)}`,{method:"DELETE"}),unhideDevice:t=>M(`/api/topology/unhide/${encodeURIComponent(t)}`,{method:"POST"}),devices:()=>M("/api/devices"),device:t=>M(`/api/devices/${encodeURIComponent(t)}`),currentOta:()=>M("/api/ota/current"),currentOtaForDevice:t=>M(`/api/ota/current?mac=${encodeURIComponent(t)}`),uploadFirmware:(t,e)=>{const i=new FormData;return i.set("mac",t),i.set("file",e),M("/api/ota/upload",{method:"POST",body:i})},startOta:t=>M(`/api/ota/start/${t}`,{method:"POST"}),abortOta:()=>M("/api/ota/abort",{method:"POST"}),cancelPending:t=>M(`/api/ota/pending/${t}`,{method:"DELETE"}),getQueue:()=>M("/api/ota/queue"),getQueuePaused:()=>M("/api/ota/queue/paused"),pauseQueue:()=>M("/api/ota/queue/pause",{method:"POST"}),resumeQueue:()=>M("/api/ota/queue/resume",{method:"POST"}),abortQueuedJob:t=>M(`/api/ota/queue/${t}/abort`,{method:"POST"}),reorderJobUp:t=>M(`/api/ota/queue/${t}/up`,{method:"POST"}),reorderJobDown:t=>M(`/api/ota/queue/${t}/down`,{method:"POST"}),history:t=>M(`/api/ota/history/${encodeURIComponent(t)}`),jobLog:t=>M(`/api/ota/jobs/${t}/log`),retained:()=>M("/api/firmware/retained"),reflash:t=>M(`/api/ota/reflash/${t}`,{method:"POST"}),deleteRetained:t=>M(`/api/firmware/retained/${t}`,{method:"DELETE"}),getConfig:t=>M(`/api/devices/${encodeURIComponent(t)}/config`),saveConfig:(t,e,i)=>M(`/api/devices/${encodeURIComponent(t)}/config`,{method:"PUT",body:JSON.stringify({content:e,scaffold:i})}),deleteConfig:t=>M(`/api/devices/${encodeURIComponent(t)}/config`,{method:"DELETE"}),checkSecrets:t=>M("/api/secrets/check",{method:"POST",body:JSON.stringify({content:t})}),importConfig:(t,e)=>{if(typeof e=="string")return M(`/api/devices/${encodeURIComponent(t)}/config/import`,{method:"POST",body:JSON.stringify({content:e})});const i=new FormData;return i.set("file",e),M(`/api/devices/${encodeURIComponent(t)}/config/import`,{method:"POST",body:i})},getConfigStatus:t=>M(`/api/devices/${encodeURIComponent(t)}/config/status`),compileDevice:(t,e=!1)=>{const i=e?"?auto_flash=true":"";return M(`/api/devices/${encodeURIComponent(t)}/compile${i}`,{method:"POST"})},getCompileStatus:t=>M(`/api/devices/${encodeURIComponent(t)}/compile/status`),cancelCompile:t=>M(`/api/devices/${encodeURIComponent(t)}/compile/cancel`,{method:"POST"}),startCompileFlash:t=>M(`/api/devices/${encodeURIComponent(t)}/compile/start-flash`,{method:"POST"}),getCompileHistory:t=>M(`/api/devices/${encodeURIComponent(t)}/compile/history`),rebootDevice:t=>M(`/api/devices/${encodeURIComponent(t)}/reboot`,{method:"POST"}),setHeartbeatInterval:(t,e)=>M(`/api/devices/${encodeURIComponent(t)}/heartbeat`,{method:"POST",body:JSON.stringify({interval_seconds:e})}),forceRediscover:t=>M(`/api/devices/${encodeURIComponent(t)}/rediscover`,{method:"POST"}),setParentMac:(t,e,i=!0)=>M(`/api/devices/${encodeURIComponent(t)}/parent`,{method:"POST",body:JSON.stringify({parent_mac:e,clear:i})}),setRelay:(t,e)=>M(`/api/devices/${encodeURIComponent(t)}/relay`,{method:"POST",body:JSON.stringify({enable:e})}),getCompileQueue:()=>M("/api/compile/queue"),getCompileHistoryAll:(t=100)=>M(`/api/compile/history?limit=${t}`),abortCompileJob:t=>M(`/api/compile/queue/${t}/abort`,{method:"POST"}),getAllHistory:async(t=100)=>{const[e,i]=await Promise.all([M(`/api/ota/history?limit=${t}`),M(`/api/compile/history?limit=${t}`)]),s=[...e.jobs,...i.jobs];return s.sort((r,n)=>(n.created_at??0)-(r.created_at??0)),{jobs:s.slice(0,t)}},getSecrets:()=>M("/api/secrets"),getChips:()=>M("/api/chips"),getBridgeNetworkCredentials:()=>M("/api/bridge/network-credentials"),saveSecrets:t=>M("/api/secrets",{method:"PUT",body:JSON.stringify({content:t})}),getContainerStatus:()=>M("/api/compile/container/status"),cleanArtifacts:()=>M("/api/compile/artifacts",{method:"DELETE"}),getSerialPorts:()=>M("/api/serial/ports"),startSerialFlash:(t,e)=>M(`/api/devices/${encodeURIComponent(t)}/flash/serial`,{method:"POST",body:JSON.stringify({port:e})}),getSerialFlashStatus:t=>M(`/api/devices/${encodeURIComponent(t)}/flash/serial/status`),cancelSerialFlash:t=>M(`/api/devices/${encodeURIComponent(t)}/flash/serial/cancel`,{method:"POST"}),restartRequired:()=>M("/api/restart-required"),requestRestart:()=>M("/api/restart",{method:"POST"}),setupStatus:()=>M("/api/setup-status"),integrationSetup:()=>M("/api/integration/setup",{method:"POST"}),detectChip:t=>M("/api/bridge/flash-wizard/detect-chip",{method:"POST",body:JSON.stringify({port:t})}),submitFlashWizard:t=>M("/api/bridge/flash-wizard/submit",{method:"POST",body:JSON.stringify(t)}),getFlashWizardStatus:()=>M("/api/bridge/flash-wizard/status"),finalizeFlashWizard:()=>M("/api/bridge/flash-wizard/finalize",{method:"POST"}),streamCompileLogs(t,e,i){const s=zt(`/api/devices/${encodeURIComponent(t)}/compile/logs`),r=new EventSource(s);return r.onmessage=n=>{e(n.data)},r.addEventListener("status",n=>{e(`[status: ${n.data}]`)}),r.addEventListener("exit",n=>{e(`[build exited with code ${n.data}]`)}),r.addEventListener("queue_position",n=>{e(`[queue position: ${n.data}]`)}),r.onerror=i,r},streamSerialFlashLogs(t,e,i,s){const r=zt(`/api/devices/${encodeURIComponent(t)}/flash/serial/logs`),n=new EventSource(r);return n.onmessage=o=>{e(o.data)},n.addEventListener("status",o=>{i(o.data)}),n.onerror=s,n},downloadFactoryBinary(t){return zt(`/api/devices/${encodeURIComponent(t)}/firmware/download`)},downloadCompileBinary(t){return zt(`/api/devices/${encodeURIComponent(t)}/compile/firmware/download`)},downloadJobBinary(t){return zt(`/api/jobs/${t}/firmware/download`)},activityLog(t,e,i){const s=zt("/api/integration/activity"),r=new EventSource(s);return r.addEventListener("line",n=>{t(n.data)}),r.addEventListener("end",()=>{e()}),r.addEventListener("error",n=>{i(n)}),r.onerror=i,r}};function mg(t){let e=null,i=!1,s=1e3;const r=()=>{if(i)return;const n=zt("/ws/topology");e=new WebSocket(n),e.onopen=()=>{s=1e3},e.onmessage=o=>{try{const a=JSON.parse(o.data);a.type==="bridge.connection"&&typeof a.payload=="object"&&a.payload!==null&&t(a.payload.connected)}catch{}},e.onclose=()=>{i||(setTimeout(r,s),s=Math.min(s*2,1e4))},e.onerror=()=>{e==null||e.close()}};return r(),{close(){i=!0,e==null||e.close()}}}function bg(t){let e=null,i=!1,s=1e3;const r=()=>{if(i)return;const n=zt("/ws/topology");e=new WebSocket(n),e.onopen=()=>{s=1e3},e.onmessage=o=>{try{const a=JSON.parse(o.data);a&&a.type==="server_id"&&typeof a.value=="string"&&(yo!==null&&yo!==a.value&&location.reload(),yo=a.value),t(a)}catch{}},e.onclose=()=>{i||(setTimeout(r,s),s=Math.min(s*2,1e4))},e.onerror=()=>{e==null||e.close()}};return r(),{close(){i=!0,e==null||e.close()}}}function ce(t){const e=t.replace(/[^0-9A-Fa-f]/g,"");return e.length!==12?t.trim().toUpperCase():e.match(/.{2}/g).join(":").toUpperCase()}function Li(t){const e=t||0;return e<1024?`${e} B`:e<1024*1024?`${(e/1024).toFixed(1)} KB`:`${(e/1024/1024).toFixed(2)} MB`}function ms(t){return t?new Date(t*1e3).toLocaleString():"-"}function mn(t){if(!t)return"-";const e=Math.max(0,Math.floor((Date.now()-t*1e3)/1e3));return e<60?`${e}s ago`:e<3600?`${Math.floor(e/60)}m ago`:e<86400?`${Math.floor(e/3600)}h ago`:`${Math.floor(e/86400)}d ago`}function ut(t){if(t==null||t<0)return"";const e=Number(t);if(e<60)return`${Math.round(e)}s`;if(e<3600)return`${Math.floor(e/60)}m ${Math.round(e%60)}s`;if(e<86400){const n=Math.floor(e/3600),o=Math.floor(e%3600/60);return`${n}h ${o}m`}const i=Math.floor(e/86400);if(i<7){const n=e%86400,o=Math.floor(n/3600);return`${i}d ${o}h`}const s=Math.floor(i/7),r=i%7;return`${s}w ${r}d`}var vg=Object.defineProperty,yg=Object.getOwnPropertyDescriptor,Jt=(t,e,i,s)=>{for(var r=s>1?void 0:s?yg(e,i):e,n=t.length-1,o;n>=0;n--)(o=t[n])&&(r=(s?o(e,i,r):o(r))||r);return s&&r&&vg(e,i,r),r};let pt=class extends he{constructor(){super(...arguments),this.childNodesData=[],this.childMap=new Map,this.jobForMac=()=>null,this.configForMac=()=>null,this.onHideDevice=()=>{},this.isRoot=!1,this.isLast=!1}selectNode(){this.node.ha_device_id?window.open(`/config/devices/device/${this.node.ha_device_id}`,"_blank"):this.dispatchEvent(new CustomEvent("node-selected",{detail:this.node.mac,bubbles:!0,composed:!0}))}navigateTo(t){window.location.hash=t}rssiBars(t){return t==null?"-":t>=-50?"▂▄▆█":t>=-65?"▂▄▆":t>=-80?"▂▄":t>=-90?"▂":"▁"}childKey(t){return ce(t.mac||"")}render(){const t=this.jobForMac(this.node.mac),e=!!t&&["starting","transferring","verifying","transfer_success_waiting_rejoin"].includes(t.status),i=!!t&&t.status==="queued",s=(t==null?void 0:t.percent)??0,r=this.childNodesData.length>0,n=!this.isRoot&&!this.node.is_bridge,o=this.configForMac(this.node.mac),a=(o==null?void 0:o.config_state)??"no_config",l=a==="compiling",c=a==="compile_queued",h=(o==null?void 0:o.queue_position)??1;return g`
  ...
  `;Jt([Q({type:Object})],pt.prototype,"node",2);Jt([Q({type:Array})],pt.prototype,"childNodesData",2);Jt([Q({attribute:!1})],pt.prototype,"childMap",2);Jt([Q({attribute:!1})],pt.prototype,"jobForMac",2);Jt([Q({attribute:!1})],pt.prototype,"configForMac",2);Jt([Q({attribute:!1})],pt.prototype,"onHideDevice",2);Jt([Q({type:Boolean})],pt.prototype,"isRoot",2);Jt([Q({type:Boolean,reflect:!0})],pt.prototype,"isLast",2);pt=Jt([ke("esp-topology-node")],pt);var xg=Object.defineProperty,wg=Object.getOwnPropertyDescriptor,yi=(t,e,i,s)=>{for(var r=s>1?void 0:s?wg(e,i):e,n=t.length-1,o;n>=0;n--)(o=t[n])&&(r=(s?o(e,i,r):o(r))||r);return s&&r&&xg(e,i,r),r};let Bt=class extends he{constructor(){super(...arguments),this.topology=[],this.currentJob=null,this.queueData=null,this.configStatuses=new Map,this.loading=!0,this.error="",this.hiddenExpanded=!1}connectedCallback(){super.connectedCallback(),this.load(),this.stream=bg(t=>{(t.type==="topology.snapshot"||t.type==="topology.changed"||t.type==="remote.availability"||t.type==="bridge.heartbeat")&&this.load(!1,!0)})}disconnectedCallback(){var t;(t=this.stream)==null||t.close(),super.disconnectedCallback()}async load(t=!0,e=!1){t&&(this.loading=!0);try{const[i,s,r]=await Promise.all([S.topology(e),S.currentOta(),S.getQueue()]);this.topology=i,this.currentJob=s.job,this.queueData=r,this.error="";const n=i.filter(l=>(l.hops??0)>0).map(l=>S.getConfigStatus(l.mac).catch(()=>null)),o=await Promise.all(n),a=new Map;o.forEach(l=>{l&&a.set(ce(l.mac),l)}),this.configStatuses=a}catch(i){this.error=i instanceof Error?i.message:String(i)}finally{this.loading=!1}}async handleHideDevice(t){try{await S.hideDevice(t),await this.load(!1,!0)}catch(e){console.error("Failed to hide device:",e)}}async handleUnhideDevice(t){try{await S.unhideDevice(t),await this.load(!1,!0)}catch(e){console.error("Failed to unhide device:",e)}}jobForMac(t){var s;const e=ce(t);return this.currentJob&&ce(this.currentJob.mac)===e?this.currentJob:(((s=this.queueData)==null?void 0:s.queued_jobs)??[]).find(r=>ce(r.mac)===e)??null}configForMac(t){return this.configStatuses.get(ce(t))??null}childKey(t){return ce(t||"")}buildChildren(){const t=new Map;for(const i of this.topology){const s=this.childKey(i.parent_mac);if(!s)continue;const r=t.get(s)||[];r.push(i),t.set(s,r)}for(const i of t.values())i.sort((s,r)=>(s.friendly_name||s.label||s.esphome_name||s.mac).localeCompare(r.friendly_name||r.label||r.esphome_name||r.mac));return{root:this.topology.find(i=>(i.hops??0)===0)||this.topology.find(i=>!i.parent_mac)||this.topology[0]||null,childMap:t}}render(){const{root:t}=this.buildChildren(),e=this.childKey((t==null?void 0:t.mac)||""),i=this.topology.filter(o=>o.hidden?!1:(o.hops??0)>0?!0:!o.is_bridge&&this.childKey(o.mac)!==e),s=this.topology.filter(o=>o.hidden),r=new Set(i.map(o=>this.childKey(o.mac))),n=new Map;for(const o of i){if(this.childKey(o.mac)===e)continue;let a=this.childKey(o.parent_mac);(!a||!r.has(a))&&(a=e);const l=n.get(a)||[];l.push(o),n.set(a,l)}for(const o of n.values())o.sort((a,l)=>(a.friendly_name||a.label||a.esphome_name||a.mac).localeCompare(l.friendly_name||l.label||l.esphome_name||l.mac));return g`
  ...
  `;yi([v()],Bt.prototype,"topology",2);yi([v()],Bt.prototype,"currentJob",2);yi([v()],Bt.prototype,"queueData",2);yi([v()],Bt.prototype,"configStatuses",2);yi([v()],Bt.prototype,"loading",2);yi([v()],Bt.prototype,"error",2);yi([v()],Bt.prototype,"hiddenExpanded",2);Bt=yi([ke("esp-topology-map")],Bt);var kg=Object.defineProperty,Sg=Object.getOwnPropertyDescriptor,Te=(t,e,i,s)=>{for(var r=s>1?void 0:s?Sg(e,i):e,n=t.length-1,o;n>=0;n--)(o=t[n])&&(r=(s?o(e,i,r):o(r))||r);return s&&r&&kg(e,i,r),r};let xe=class extends he{constructor(){super(...arguments),this.mac="",this.online=!1,this.isRemote=!1,this.relayNodes=[],this.relayEnabled=!1,this.busy="",this.heartbeatSeconds=60,this.selectedParent="",this.customParentMac="",this.showRelayModal=!1,this.showHeartbeatModal=!1,this.showParentModal=!1,this.parentDropdownOpen=!1,this.showConfirmModal="",this.confirmAction=null,this.toast=null}disconnectedCallback(){this.toastTimer&&window.clearTimeout(this.toastTimer),super.disconnectedCallback()}disabled(t=""){return!this.online||!!this.busy||!!t&&this.busy!==t}notify(t,e){this.toast={message:t,tone:e},this.toastTimer&&window.clearTimeout(this.toastTimer),this.toastTimer=window.setTimeout(()=>{this.toast=null},4500)}configError(t,e,i){if(e===void 0){console.error("Unexpected config response:",i),this.notify(`${t} returned an unexpected response`,"error");return}const r={rejected:"Config Fail Device Rejected",busy:"Config Fail Device Busy",timeout:"Config Fail Device Timeout",no_session:"Config Fail No Session",not_remote:"Config Fail Not Remote",invalid_payload:"Config Fail Invalid Payload",unsupported:"Config Fail Unsupported"}[e]??`${t} returned ${e}`;this.notify(r,"error")}dispatchChanged(){this.dispatchEvent(new CustomEvent("config-changed",{bubbles:!0,composed:!0}))}reboot(){this.showConfirmModal="Reboot",this.confirmAction=()=>{this.busy="reboot",S.rebootDevice(this.mac).then(t=>{t.result==="ok"?(this.notify("Reboot command accepted","ok"),this.dispatchChanged()):this.configError(t.command,t.result,t)}).catch(t=>{this.notify(t instanceof Error?t.message:String(t),"error")}).finally(()=>{this.busy=""})}}rediscover(){this.showConfirmModal="Rediscover",this.confirmAction=()=>{this.busy="rediscover",S.forceRediscover(this.mac).then(t=>{t.result==="ok"?(this.notify("Rediscover command accepted","ok"),this.dispatchChanged()):this.configError(t.command,t.result,t)}).catch(t=>{this.notify(t instanceof Error?t.message:String(t),"error")}).finally(()=>{this.busy=""})}}applyHeartbeat(){const t=Math.trunc(Number(this.heartbeatSeconds));return t<5||t>3600?(this.notify("Heartbeat must be 5-3600 seconds","error"),Promise.resolve()):(console.log("[debug-modal] applyHeartbeat setting showHeartbeatModal=false"),this.showHeartbeatModal=!1,this.busy="heartbeat",S.setHeartbeatInterval(this.mac,t).then(e=>{e.result==="ok"?(this.notify("Heartbeat interval set","ok"),this.dispatchChanged()):this.configError(e.command,e.result,e)}).catch(e=>{this.notify(e instanceof Error?e.message:String(e),"error")}).finally(()=>{this.busy=""}))}applyParent(t){const e=ce((this.customParentMac||this.selectedParent).trim());if(!/^[0-9A-F]{2}(:[0-9A-F]{2}){5}$/.test(e)){this.notify("Parent MAC is invalid","error");return}this.showParentModal=!1,this.busy="parent",S.setParentMac(this.mac,e,t).then(i=>{i.result==="ok"?(this.notify("Parent set","ok"),this.dispatchChanged()):this.configError(i.command,i.result,i)}).catch(i=>{this.notify(i instanceof Error?i.message:String(i),"error")}).finally(()=>{this.busy=""})}openRelayModal(){this.showRelayModal=!0}closeRelayModal(){this.showRelayModal=!1}applyRelayModal(t){this.showRelayModal=!1,this.busy="relay",S.setRelay(this.mac,t).then(e=>{if(e.result!==void 0&&!["no_session","timeout","rejected","busy","invalid_payload","not_remote"].includes(e.result)){const s=e.result==="ok"?t?"Relay Enabled Successfully":"Relay Disabled Successfully":e.result;this.notify(s,"ok"),this.dispatchChanged()}else this.configError(e.command,e.result,e)}).catch(e=>{this.notify(e instanceof Error?e.message:String(e),"error")}).finally(()=>{this.busy=""})}render(){return this.isRemote?g`
    ...
    `}handleBackdropClick(t){t.composedPath().some(i=>{var s;return(s=i.classList)==null?void 0:s.contains("modal")})||(this.showHeartbeatModal=!1,this.showParentModal=!1,this.showConfirmModal="")}renderParentModal(){const t=!!(this.customParentMac.trim()||this.selectedParent),e=this.relayNodes.filter(i=>ce(i.mac)!==ce(this.mac));return g`
      <div class="modal-backdrop" @click=${this.handleBackdropClick}>
        <div class="modal" @click=${i=>i.stopPropagation()}>
          ...
          <label>
            ...
            >
              ...
              ${e.map(i=>g`
                <option value=${ce(i.mac)}>
                  ${i.friendly_name||i.esphome_name||i.label||ce(i.mac)}
                </option>
              `)}
...
`)}findBlockEnd(t,e,i=0){const s=t.findIndex((n,o)=>o>=i&&e.test(n));if(s<0)return-1;let r=s+1;for(;r<t.length&&(t[r].startsWith(" ")||t[r].startsWith("	"));)r++;return r}async applyExternalComponentsFix(){this.showExternalComponentsFix=!1,this.insertExternalComponentsFix(),this.yamlWarnings=[],this.hasUnsavedChanges=!0,this.requestUpdate();const t=this.pendingAction,e=this.pendingAutoFlash;this.pendingAction=null,this.pendingAutoFlash=!1,t==="save"?await this.saveConfig(!0):t==="compile"&&await this.queueCompile(e,!0)}async dismissExternalComponentsFix(){this.showExternalComponentsFix=!1;const t=this.pendingAction,e=this.pendingAutoFlash;this.pendingAction=null,this.pendingAutoFlash=!1,t==="save"?await this.saveConfig(!0):t==="compile"&&await this.queueCompile(e,!0)}async dismissSecretsWarning(){this.showSecretsWarning=!1;const t=this.pendingAction,e=this.pendingAutoFlash;this.pendingAction=null,this.pendingAutoFlash=!1,t==="compile"&&await this.queueCompile(e,!0)}goToSecretsFromWarning(){this.showSecretsWarning=!1,this.goToSecrets()}async checkForMissingSecrets(){try{return(await S.checkSecrets(this.editorContent)).missing_secrets}catch{return[]}}async queueCompile(t,e=!1){if(!(this.compilePhase==="compiling"||this.compilePhase==="compile_queued")){if(!e){const i=await this.checkForMissingSecrets();if(i.length>0){this.missingSecrets=i,this.pendingAction="compile",this.pendingAutoFlash=t,this.showSecretsWarning=!0;return}}if(!e&&!il(this.editorContent)){this.pendingAction="compile",this.pendingAutoFlash=t,this.showExternalComponentsFix=!0;return}this.hasUnsavedChanges&&await this.saveConfig(!0),this.compilePhase="compiling",this.compileStartedAt=Date.now(),this.startElapsedTimer(),this.error="",this.showCompileLog=!0;try{const i=await S.compileDevice(this.mac,t);this.compileJobId=i.job.id,this.preflight=i.preflight||null,i.job.status==="compile_queued"?(this.compilePhase="compile_queued",this.compileQueuePosition=i.queue_position):i.job.status==="compiling"&&(this.compilePhase="compiling",this.compileQueuePosition=null),this.startPolling()}catch(i){this.compilePhase="failed",this.compileStartedAt=null,this.stopElapsedTimer(),this.error=i instanceof Error?i.message:String(i)}}}async triggerCompile(){this.flashIntent="none",await this.queueCompile(!1)}async triggerOtaFlash(){this.flashIntent="ota",await this.queueCompile(!0)}async triggerBrowserFlashFlow(){this.flashIntent="browser",await this.queueCompile(!1)}async cancelCompile(){try{await S.cancelCompile(this.mac)}catch{}this.compilePhase="idle",this.compileJobId=null,this.compileQueuePosition=null,this.compileStartedAt=null,this.flashIntent="none",this.clearBrowserFlashManifestUrl(),this.stopElapsedTimer(),this.stopPolling()}goBack(){window.location.hash=`/device/${encodeURIComponent(this.mac)}`}goToTopology(){window.location.hash="/"}goToSecrets(){window.location.hash=`/secrets?from=${encodeURIComponent(window.location.hash)}`}updated(t){(t.has("compilePhase")||t.has("device")||t.has("preflight"))&&this.updateBrowserFlashManifestUrl()}render(){var c,h,d,f,u;const t=String(((c=this.device)==null?void 0:c.esphome_name)||((h=this.device)==null?void 0:h.label)||this.mac),e=String(((d=this.device)==null?void 0:d.chip_name)||"-"),i=this.topology.find(p=>ce(p.mac)===ce(this.mac)),s=(i==null?void 0:i.online)??!!((f=this.device)!=null&&f.online),r=this.device,o=!!!(r!=null&&r.is_bridge)&&((r==null?void 0:r.hops)??0)>0,a=this.browserFlashChipFamily,l=this.compilePhase==="compiled"&&!!this.browserFlashManifestUrl;return g`
  ...
  `;le([Q({type:String})],re.prototype,"mac",2);le([v()],re.prototype,"state",2);le([v()],re.prototype,"device",2);le([v()],re.prototype,"config",2);le([v()],re.prototype,"editorContent",2);le([v()],re.prototype,"saveIndicator",2);le([v()],re.prototype,"hasUnsavedChanges",2);le([v()],re.prototype,"error",2);le([v()],re.prototype,"compilePhase",2);le([v()],re.prototype,"topology",2);le([v()],re.prototype,"compileJobId",2);le([v()],re.prototype,"compileQueuePosition",2);le([v()],re.prototype,"preflight",2);le([v()],re.prototype,"chipUnknown",2);le([v()],re.prototype,"yamlWarnings",2);le([v()],re.prototype,"showExternalComponentsFix",2);le([v()],re.prototype,"showSecretsWarning",2);le([v()],re.prototype,"missingSecrets",2);le([v()],re.prototype,"showCompileLog",2);le([v()],re.prototype,"compileStartedAt",2);le([v()],re.prototype,"flashIntent",2);le([v()],re.prototype,"browserFlashManifestUrl",2);le([Pd("esp-compile-log-viewer")],re.prototype,"compileLogViewer",2);re=le([ke("esp-config-page")],re);var ak=Object.defineProperty,lk=Object.getOwnPropertyDescriptor,Ms=(t,e,i,s)=>{for(var r=s>1?void 0:s?lk(e,i):e,n=t.length-1,o;n>=0;n--)(o=t[n])&&(r=(s?o(e,i,r):o(r))||r);return s&&r&&ak(e,i,r),r};let mi=class extends he{constructor(){super(...arguments),this.from="/",this.content="",this.saved=!1,this.loading=!0,this.error=""}connectedCallback(){super.connectedCallback(),this.load()}async load(){this.loading=!0;try{const t=await S.getSecrets();this.content=t.content,this.error=""}catch(t){this.error=t instanceof Error?t.message:String(t)}finally{this.loading=!1}}async save(){this.saved=!1;try{await S.saveSecrets(this.content),this.saved=!0,this.error="",setTimeout(()=>{this.saved=!1,this.requestUpdate()},2e3)}catch(t){this.error=t instanceof Error?t.message:String(t)}}onInput(t){this.content=t.target.value}goBack(){window.location.hash=this.from}render(){const t=this.from==="/"?"topology":"device config";return g`
...
//# sourceMappingURL=index-DpWFXMoK.js.map
