 ...
 */function Pd(t,e){return(i,s,r)=>{const n=o=>{var a;return((a=o.renderRoot)==null?void 0:a.querySelector(t))??null};return dg(i,s,{get(){return n(this)}})}}const fg=(()=>{const t=document.querySelector('meta[name="x-ingress-path"]');return t&&t.getAttribute("content")?t.getAttribute("content").replace(/\/+$/,""):""})(),ug=15e3,pg=3e4;let Er=null,yo=null;function zt(t){const e=fg||"";return t.startsWith("/")?e+t:e+"/"+t}function gg(t,e){if(!t)return null;if(e!=null&&e.includes("application/json"))return JSON.parse(t);try{return JSON.parse(t)}catch{return t}}async function M(t,e){const i=new AbortController,s=setTimeout(()=>i.abort("timeout"),ug);try{const r=await fetch(zt(t),{...e,signal:i.signal,headers:(e==null?void 0:e.body)instanceof FormData?e.headers:{"Content-Type":"application/json",...(e==null?void 0:e.headers)||{}}});clearTimeout(s);const n=await r.text(),o=gg(n,r.headers.get("content-type"));if(!r.ok){let a=`${r.status} ${r.statusText}`;if(o&&typeof o=="object"){const l=o,c=l.detail,h=l.error;typeof c=="string"&&c?a=c:typeof h=="string"&&h&&(a=h)}else typeof o=="string"&&o&&(a=o);throw new Error(a)}return o}catch(r){if(clearTimeout(s),r instanceof DOMException&&r.name==="AbortError"){const n=i.signal.reason;throw new Error(n==="timeout"?"timeout":"cancelled")}throw r}}const S={config:()=>M("/api/config"),updateConfig:t=>M("/api/config",{method:"PUT",body:JSON.stringify(t)}),discoverBridges:()=>M("/api/bridge/discover").then(t=>Array.isArray(t)?{bridges:t,scanning:!0}:{bridges:t.bridges??[],scanning:!!t.scanning}),triggerScan:()=>M("/api/bridge/scan",{method:"POST"}),getScanLog:()=>M("/api/bridge/scan-log"),getBridges:()=>M("/api/bridges"),scanSerialPorts:()=>M("/api/serial/ports").then(t=>t.ports),addBridge:(t,e=80,i,s,r,n="wifi",o,a=460800)=>M("/api/bridges",{method:"POST",body:JSON.stringify({host:t,port:e,name:i,api_key:s,hostname:r,transport:n,serial_port:o,baud:a})}),updateBridge:(t,e,i,s,r)=>M(`/api/bridges/${t}`,{method:"PUT",body:JSON.stringify({name:e,host:i,port:s,api_key:r})}),deleteBridge:t=>M(`/api/bridges/${t}`,{method:"DELETE"}),activateBridge:t=>M(`/api/bridges/${t}/activate`,{method:"PUT"}),deactivateBridge:t=>M(`/api/bridges/${t}/deactivate`,{method:"PUT"}),bridgeReconnect:t=>M(`/api/bridges/${t}/reconnect`,{method:"POST"}),selectBridge:(t,e,i,s,r,n,o)=>M("/api/bridge/select",{method:"POST",body:JSON.stringify({host:t,port:e,name:i,version:s,api_key:r,network_id:n,hostname:o})}),topology:(t=!1)=>{const e=Date.now();return!t&&Er&&e-Er.ts<pg?Promise.resolve(Er.data):M("/api/bridge/topology.json").then(i=>(Er={data:i,ts:e},i))},hideDevice:t=>M(`/api/topology/hide/${encodeURIComponent(t)}`,{method:"DELETE"}),unhideDevice:t=>M(`/api/topology/unhide/${encodeURIComponent(t)}`,{method:"POST"}),devices:()=>M("/api/devices"),device:t=>M(`/api/devices/${encodeURIComponent(t)}`),currentOta:()=>M("/api/ota/current"),currentOtaForDevice:t=>M(`/api/ota/current?mac=${encodeURIComponent(t)}`),uploadFirmware:(t,e)=>{const i=new FormData;return i.set("mac",t),i.set("file",e),M("/api/ota/upload",{method:"POST",body:i})},startOta:t=>M(`/api/ota/start/${t}`,{method:"POST"}),abortOta:()=>M("/api/ota/abort",{method:"POST"}),cancelPending:t=>M(`/api/ota/pending/${t}`,{method:"DELETE"}),getQueue:()=>M("/api/ota/queue"),getQueuePaused:()=>M("/api/ota/queue/paused"),pauseQueue:()=>M("/api/ota/queue/pause",{method:"POST"}),resumeQueue:()=>M("/api/ota/queue/resume",{method:"POST"}),abortQueuedJob:t=>M(`/api/ota/queue/${t}/abort`,{method:"POST"}),reorderJobUp:t=>M(`/api/ota/queue/${t}/up`,{method:"POST"}),reorderJobDown:t=>M(`/api/ota/queue/${t}/down`,{method:"POST"}),history:t=>M(`/api/ota/history/${encodeURIComponent(t)}`),jobLog:t=>M(`/api/ota/jobs/${t}/log`),retained:()=>M("/api/firmware/retained"),reflash:t=>M(`/api/ota/reflash/${t}`,{method:"POST"}),deleteRetained:t=>M(`/api/firmware/retained/${t}`,{method:"DELETE"}),getConfig:t=>M(`/api/devices/${encodeURIComponent(t)}/config`),saveConfig:(t,e,i)=>M(`/api/devices/${encodeURIComponent(t)}/config`,{method:"PUT",body:JSON.stringify({content:e,scaffold:i})}),deleteConfig:t=>M(`/api/devices/${encodeURIComponent(t)}/config`,{method:"DELETE"}),checkSecrets:t=>M("/api/secrets/check",{method:"POST",body:JSON.stringify({content:t})}),importConfig:(t,e)=>{if(typeof e=="string")return M(`/api/devices/${encodeURIComponent(t)}/config/import`,{method:"POST",body:JSON.stringify({content:e})});const i=new FormData;return i.set("file",e),M(`/api/devices/${encodeURIComponent(t)}/config/import`,{method:"POST",body:i})},getConfigStatus:t=>M(`/api/devices/${encodeURIComponent(t)}/config/status`),compileDevice:(t,e=!1)=>{const i=e?"?auto_flash=true":"";return M(`/api/devices/${encodeURIComponent(t)}/compile${i}`,{method:"POST"})},getCompileStatus:t=>M(`/api/devices/${encodeURIComponent(t)}/compile/status`),cancelCompile:t=>M(`/api/devices/${encodeURIComponent(t)}/compile/cancel`,{method:"POST"}),startCompileFlash:t=>M(`/api/devices/${encodeURIComponent(t)}/compile/start-flash`,{method:"POST"}),getCompileHistory:t=>M(`/api/devices/${encodeURIComponent(t)}/compile/history`),rebootDevice:t=>M(`/api/devices/${encodeURIComponent(t)}/reboot`,{method:"POST"}),setHeartbeatInterval:(t,e)=>M(`/api/devices/${encodeURIComponent(t)}/heartbeat`,{method:"POST",body:JSON.stringify({interval_seconds:e})}),forceRediscover:t=>M(`/api/devices/${encodeURIComponent(t)}/rediscover`,{method:"POST"}),setParentMac:(t,e,i=!0)=>M(`/api/devices/${encodeURIComponent(t)}/parent`,{method:"POST",body:JSON.stringify({parent_mac:e,clear:i})}),setRelay:(t,e)=>M(`/api/devices/${encodeURIComponent(t)}/relay`,{method:"POST",body:JSON.stringify({enable:e})}),getCompileQueue:()=>M("/api/compile/queue"),getCompileHistoryAll:(t=100)=>M(`/api/compile/history?limit=${t}`),abortCompileJob:t=>M(`/api/compile/queue/${t}/abort`,{method:"POST"}),getAllHistory:async(t=100)=>{const[e,i]=await Promise.all([M(`/api/ota/history?limit=${t}`),M(`/api/compile/history?limit=${t}`)]),s=[...e.jobs,...i.jobs];return s.sort((r,n)=>(n.created_at??0)-(r.created_at??0)),{jobs:s.slice(0,t)}},getSecrets:()=>M("/api/secrets"),saveSecrets:t=>M("/api/secrets",{method:"PUT",body:JSON.stringify({content:t})}),getContainerStatus:()=>M("/api/compile/container/status"),cleanArtifacts:()=>M("/api/compile/artifacts",{method:"DELETE"}),getSerialPorts:()=>M("/api/serial/ports"),startSerialFlash:(t,e)=>M(`/api/devices/${encodeURIComponent(t)}/flash/serial`,{method:"POST",body:JSON.stringify({port:e})}),getSerialFlashStatus:t=>M(`/api/devices/${encodeURIComponent(t)}/flash/serial/status`),cancelSerialFlash:t=>M(`/api/devices/${encodeURIComponent(t)}/flash/serial/cancel`,{method:"POST"}),restartRequired:()=>M("/api/restart-required"),requestRestart:()=>M("/api/restart",{method:"POST"}),setupStatus:()=>M("/api/setup-status"),integrationSetup:()=>M("/api/integration/setup",{method:"POST"}),detectChip:t=>M("/api/bridge/flash-wizard/detect-chip",{method:"POST",body:JSON.stringify({port:t})}),submitFlashWizard:t=>M("/api/bridge/flash-wizard/submit",{method:"POST",body:JSON.stringify(t)}),getFlashWizardStatus:()=>M("/api/bridge/flash-wizard/status"),finalizeFlashWizard:()=>M("/api/bridge/flash-wizard/finalize",{method:"POST"}),streamCompileLogs(t,e,i){const s=zt(`/api/devices/${encodeURIComponent(t)}/compile/logs`),r=new EventSource(s);return r.onmessage=n=>{e(n.data)},r.addEventListener("status",n=>{e(`[status: ${n.data}]`)}),r.addEventListener("exit",n=>{e(`[build exited with code ${n.data}]`)}),r.addEventListener("queue_position",n=>{e(`[queue position: ${n.data}]`)}),r.onerror=i,r},streamSerialFlashLogs(t,e,i,s){const r=zt(`/api/devices/${encodeURIComponent(t)}/flash/serial/logs`),n=new EventSource(r);return n.onmessage=o=>{e(o.data)},n.addEventListener("status",o=>{i(o.data)}),n.onerror=s,n},downloadFactoryBinary(t){return zt(`/api/devices/${encodeURIComponent(t)}/firmware/download`)},downloadCompileBinary(t){return zt(`/api/devices/${encodeURIComponent(t)}/compile/firmware/download`)},downloadJobBinary(t){return zt(`/api/jobs/${t}/firmware/download`)},activityLog(t,e,i){const s=zt("/api/integration/activity"),r=new EventSource(s);return r.addEventListener("line",n=>{t(n.data)}),r.addEventListener("end",()=>{e()}),r.addEventListener("error",n=>{i(n)}),r.onerror=i,r}};function mg(t){let e=null,i=!1,s=1e3;const r=()=>{if(i)return;const n=zt("/ws/topology");e=new WebSocket(n),e.onopen=()=>{s=1e3},e.onmessage=o=>{try{const a=JSON.parse(o.data);a.type==="bridge.connection"&&typeof a.payload=="object"&&a.payload!==null&&t(a.payload.connected)}catch{}},e.onclose=()=>{i||(setTimeout(r,s),s=Math.min(s*2,1e4))},e.onerror=()=>{e==null||e.close()}};return r(),{close(){i=!0,e==null||e.close()}}}function bg(t){let e=null,i=!1,s=1e3;const r=()=>{if(i)return;const n=zt("/ws/topology");e=new WebSocket(n),e.onopen=()=>{s=1e3},e.onmessage=o=>{try{const a=JSON.parse(o.data);a&&a.type==="server_id"&&typeof a.value=="string"&&(yo!==null&&yo!==a.value&&location.reload(),yo=a.value),t(a)}catch{}},e.onclose=()=>{i||(setTimeout(r,s),s=Math.min(s*2,1e4))},e.onerror=()=>{e==null||e.close()}};return r(),{close(){i=!0,e==null||e.close()}}}function le(t){const e=t.replace(/[^0-9A-Fa-f]/g,"");return e.length!==12?t.trim().toUpperCase():e.match(/.{2}/g).join(":").toUpperCase()}function Li(t){const e=t||0;return e<1024?`${e} B`:e<1024*1024?`${(e/1024).toFixed(1)} KB`:`${(e/1024/1024).toFixed(2)} MB`}function ms(t){return t?new Date(t*1e3).toLocaleString():"-"}function mn(t){if(!t)return"-";const e=Math.max(0,Math.floor((Date.now()-t*1e3)/1e3));return e<60?`${e}s ago`:e<3600?`${Math.floor(e/60)}m ago`:e<86400?`${Math.floor(e/3600)}h ago`:`${Math.floor(e/86400)}d ago`}function ut(t){if(t==null||t<0)return"";const e=Number(t);if(e<60)return`${Math.round(e)}s`;if(e<3600)return`${Math.floor(e/60)}m ${Math.round(e%60)}s`;if(e<86400){const n=Math.floor(e/3600),o=Math.floor(e%3600/60);return`${n}h ${o}m`}const i=Math.floor(e/86400);if(i<7){const n=e%86400,o=Math.floor(n/3600);return`${i}d ${o}h`}const s=Math.floor(i/7),r=i%7;return`${s}w ${r}d`}var vg=Object.defineProperty,yg=Object.getOwnPropertyDescriptor,Jt=(t,e,i,s)=>{for(var r=s>1?void 0:s?yg(e,i):e,n=t.length-1,o;n>=0;n--)(o=t[n])&&(r=(s?o(e,i,r):o(r))||r);return s&&r&&vg(e,i,r),r};let pt=class extends ce{constructor(){super(...arguments),this.childNodesData=[],this.childMap=new Map,this.jobForMac=()=>null,this.configForMac=()=>null,this.onHideDevice=()=>{},this.isRoot=!1,this.isLast=!1}selectNode(){this.node.ha_device_id?window.open(`/config/devices/device/${this.node.ha_device_id}`,"_blank"):this.dispatchEvent(new CustomEvent("node-selected",{detail:this.node.mac,bubbles:!0,composed:!0}))}navigateTo(t){window.location.hash=t}rssiBars(t){return t==null?"-":t>=-50?"▂▄▆█":t>=-65?"▂▄▆":t>=-80?"▂▄":t>=-90?"▂":"▁"}childKey(t){return le(t.mac||"")}render(){const t=this.jobForMac(this.node.mac),e=!!t&&["starting","transferring","verifying","transfer_success_waiting_rejoin"].includes(t.status),i=!!t&&t.status==="queued",s=(t==null?void 0:t.percent)??0,r=this.childNodesData.length>0,n=!this.isRoot&&!this.node.is_bridge,o=this.configForMac(this.node.mac),a=(o==null?void 0:o.config_state)??"no_config",l=a==="compiling",c=a==="compile_queued",h=(o==null?void 0:o.queue_position)??1;return g`
      <div class="tree-row">
        ...
        <div class="tree-node ${this.node.online?"online":"offline"}" @click=${this.selectNode}>
          ...
          <span class="metrics">
            <span class="${this.node.online?"":"offline-metric"}">${this.node.online?ut(this.node.uptime_s):g`<button class="hide-pill" title="hide until back online" @click=${d=>{d.stopPropagation(),this.onHideDevice(this.node.mac)}}>✕ hide</button>`}</span>
            ${this.isRoot||this.node.last_seen_ago==null?g`<span class="pill-placeholder">—</span>`:g`<span class="last-seen">${ut(this.node.last_seen_ago)} ago</span>`}
  ...
  `;Jt([Q({type:Object})],pt.prototype,"node",2);Jt([Q({type:Array})],pt.prototype,"childNodesData",2);Jt([Q({attribute:!1})],pt.prototype,"childMap",2);Jt([Q({attribute:!1})],pt.prototype,"jobForMac",2);Jt([Q({attribute:!1})],pt.prototype,"configForMac",2);Jt([Q({attribute:!1})],pt.prototype,"onHideDevice",2);Jt([Q({type:Boolean})],pt.prototype,"isRoot",2);Jt([Q({type:Boolean,reflect:!0})],pt.prototype,"isLast",2);pt=Jt([we("esp-topology-node")],pt);var xg=Object.defineProperty,wg=Object.getOwnPropertyDescriptor,yi=(t,e,i,s)=>{for(var r=s>1?void 0:s?wg(e,i):e,n=t.length-1,o;n>=0;n--)(o=t[n])&&(r=(s?o(e,i,r):o(r))||r);return s&&r&&xg(e,i,r),r};let Bt=class extends ce{constructor(){super(...arguments),this.topology=[],this.currentJob=null,this.queueData=null,this.configStatuses=new Map,this.loading=!0,this.error="",this.hiddenExpanded=!1}connectedCallback(){super.connectedCallback(),this.load(),this.stream=bg(t=>{(t.type==="topology.snapshot"||t.type==="topology.changed"||t.type==="remote.availability"||t.type==="bridge.heartbeat")&&this.load(!1,!0)})}disconnectedCallback(){var t;(t=this.stream)==null||t.close(),super.disconnectedCallback()}async load(t=!0,e=!1){t&&(this.loading=!0);try{const[i,s,r]=await Promise.all([S.topology(e),S.currentOta(),S.getQueue()]);this.topology=i,this.currentJob=s.job,this.queueData=r,this.error="";const n=i.filter(l=>(l.hops??0)>0).map(l=>S.getConfigStatus(l.mac).catch(()=>null)),o=await Promise.all(n),a=new Map;o.forEach(l=>{l&&a.set(le(l.mac),l)}),this.configStatuses=a}catch(i){this.error=i instanceof Error?i.message:String(i)}finally{this.loading=!1}}async handleHideDevice(t){try{await S.hideDevice(t),await this.load(!1,!0)}catch(e){console.error("Failed to hide device:",e)}}async handleUnhideDevice(t){try{await S.unhideDevice(t),await this.load(!1,!0)}catch(e){console.error("Failed to unhide device:",e)}}jobForMac(t){var s;const e=le(t);return this.currentJob&&le(this.currentJob.mac)===e?this.currentJob:(((s=this.queueData)==null?void 0:s.queued_jobs)??[]).find(r=>le(r.mac)===e)??null}configForMac(t){return this.configStatuses.get(le(t))??null}childKey(t){return le(t||"")}buildChildren(){const t=new Map;for(const i of this.topology){const s=this.childKey(i.parent_mac);if(!s)continue;const r=t.get(s)||[];r.push(i),t.set(s,r)}for(const i of t.values())i.sort((s,r)=>(s.friendly_name||s.label||s.esphome_name||s.mac).localeCompare(r.friendly_name||r.label||r.esphome_name||r.mac));return{root:this.topology.find(i=>(i.hops??0)===0)||this.topology.find(i=>!i.parent_mac)||this.topology[0]||null,childMap:t}}render(){const{root:t}=this.buildChildren(),e=this.childKey((t==null?void 0:t.mac)||""),i=this.topology.filter(o=>o.hidden?!1:(o.hops??0)>0?!0:!o.is_bridge&&this.childKey(o.mac)!==e),s=this.topology.filter(o=>o.hidden),r=new Set(i.map(o=>this.childKey(o.mac))),n=new Map;for(const o of i){if(this.childKey(o.mac)===e)continue;let a=this.childKey(o.parent_mac);(!a||!r.has(a))&&(a=e);const l=n.get(a)||[];l.push(o),n.set(a,l)}for(const o of n.values())o.sort((a,l)=>(a.friendly_name||a.label||a.esphome_name||a.mac).localeCompare(l.friendly_name||l.label||l.esphome_name||l.mac));return g`
  ...
  `;Te([Q({type:String})],ye.prototype,"mac",2);Te([Q({type:Boolean})],ye.prototype,"online",2);Te([Q({type:Boolean})],ye.prototype,"isRemote",2);Te([Q({type:Array})],ye.prototype,"relayNodes",2);Te([Q({type:Boolean})],ye.prototype,"relayEnabled",2);Te([v()],ye.prototype,"busy",2);Te([v()],ye.prototype,"heartbeatSeconds",2);Te([v()],ye.prototype,"selectedParent",2);Te([v()],ye.prototype,"customParentMac",2);Te([v()],ye.prototype,"showRelayModal",2);Te([v()],ye.prototype,"showHeartbeatModal",2);Te([v()],ye.prototype,"showParentModal",2);Te([v()],ye.prototype,"parentDropdownOpen",2);Te([v()],ye.prototype,"showConfirmModal",2);Te([v()],ye.prototype,"confirmAction",2);Te([v()],ye.prototype,"toast",2);ye=Te([we("esp-device-config")],ye);var Cg=Object.defineProperty,Og=Object.getOwnPropertyDescriptor,ll=(t,e,i,s)=>{for(var r=s>1?void 0:s?Og(e,i):e,n=t.length-1,o;n>=0;n--)(o=t[n])&&(r=(s?o(e,i,r):o(r))||r);return s&&r&&Cg(e,i,r),r};let tr=class extends ce{constructor(){super(...arguments),this.showAbort=!1}abort(){this.dispatchEvent(new CustomEvent("abort",{bubbles:!0,composed:!0}))}render(){const t=Math.max(0,Math.min(100,Number(this.job.percent||0))),i=["success","failed","aborted","rejoin_timeout","version_mismatch"].includes(this.job.status)?this.job.status==="success"?"progress-panel success":"progress-panel failure":"progress-panel",s=this.job.parsed_esphome_name||this.job.esphome_name||this.job.firmware_name||"firmware.ota.bin";return g`
      <section class="${i}">
  ...
  `;mt([Q({type:String})],Ze.prototype,"mac",2);mt([Q({type:Object})],Ze.prototype,"node",2);mt([Q({type:Boolean})],Ze.prototype,"showEditYaml",2);mt([Q({type:Object})],Ze.prototype,"currentJob",2);mt([v()],Ze.prototype,"pendingJob",2);mt([v()],Ze.prototype,"preflight",2);mt([v()],Ze.prototype,"acceptedWarnings",2);mt([v()],Ze.prototype,"busy",2);mt([v()],Ze.prototype,"error",2);mt([v()],Ze.prototype,"showAbortModal",2);Ze=mt([we("esp-ota-box")],Ze);var Pg=Object.defineProperty,Tg=Object.getOwnPropertyDescriptor,kr=(t,e,i,s)=>{for(var r=s>1?void 0:s?Tg(e,i):e,n=t.length-1,o;n>=0;n--)(o=t[n])&&(r=(s?o(e,i,r):o(r))||r);return s&&r&&Pg(e,i,r),r};let Hi=class extends ce{constructor(){super(...arguments),this.jobs=[],this.mac="",this.busyJob=null,this.error=""}retained(t){return!!t.firmware_path&&!!t.retained_until&&t.retained_until>Math.floor(Date.now()/1e3)}viewLog(t){const e=`/device/${encodeURIComponent(this.mac||t.mac)}`;window.location.hash=`/job/${t.id}?from=${encodeURIComponent(e)}`}async reflash(t){this.busyJob=t.id,this.error="";try{const e=await S.reflash(t.id);this.dispatchEvent(new CustomEvent("ota-reflash-result",{bubbles:!0,composed:!0,detail:{job:e.job,preflight:e.preflight}})),this.dispatchChanged()}catch(e){this.error=e instanceof Error?e.message:String(e)}finally{this.busyJob=null}}async deleteRetained(t){this.busyJob=t.id,this.error="";try{await S.deleteRetained(t.id),this.dispatchChanged()}catch(e){this.error=e instanceof Error?e.message:String(e)}finally{this.busyJob=null}}dispatchChanged(){this.dispatchEvent(new CustomEvent("ota-changed",{bubbles:!0,composed:!0}))}statusLabel(t){return t.status==="success"?"OTA Upload Success":t.status.replaceAll("_"," ")}statusStyle(t){return{success:"background:#dcfce7;color:#15803d;",failed:"background:#fef2f2;color:#dc2626;",aborted:"background:#fef3c7;color:#b45309;",rejoin_timeout:"background:#fef3c7;color:#b45309;",version_mismatch:"background:#fef3c7;color:#b45309;"}[t]||"background:#f1f5f9;color:#475569;"}render(){return g`
      <section>
        ...
        ${this.jobs.length?g`
              <div class="table">
                ${this.jobs.map(t=>{const e=t.completed_at&&t.started_at?ut(t.completed_at-t.started_at):"";return g`
                      <article>
  ...
  `;kr([Q({type:Array})],Hi.prototype,"jobs",2);kr([Q({type:String})],Hi.prototype,"mac",2);kr([v()],Hi.prototype,"busyJob",2);kr([v()],Hi.prototype,"error",2);Hi=kr([we("esp-flash-history")],Hi);var Mg=Object.defineProperty,Eg=Object.getOwnPropertyDescriptor,cl=(t,e,i,s)=>{for(var r=s>1?void 0:s?Eg(e,i):e,n=t.length-1,o;n>=0;n--)(o=t[n])&&(r=(s?o(e,i,r):o(r))||r);return s&&r&&Mg(e,i,r),r};let ir=class extends ce{constructor(){super(...arguments),this.jobs=[],this.mac=""}viewJobLog(t){const e=`/device/${encodeURIComponent(this.mac)}`;window.location.hash=`/job/${t.id}?from=${encodeURIComponent(e)}`}statusLabel(t){return t.status==="compile_success"?"compile success":t.status.replaceAll("_"," ")}statusStyle(t){return{compile_success:"background:#dcfce7;color:#15803d;",success:"background:#dcfce7;color:#15803d;",failed:"background:#fef2f2;color:#dc2626;"}[t]||"background:#f1f5f9;color:#475569;"}render(){const t=this.jobs.filter(e=>e.status==="compile_success"||e.status==="failed");return g`
      <section>
        ...
        ${t.length?g`
              <div class="table">
                ${t.map(e=>{const i=e.completed_at&&e.started_at?ut(e.completed_at-e.started_at):"";return g`
                      <article>
                        <span class="device-info">
  ...
  `;cl([Q({type:Array})],ir.prototype,"jobs",2);cl([Q({type:String})],ir.prototype,"mac",2);ir=cl([we("esp-compile-history")],ir);/**
 * @license
...
`)}</pre>`}
  ...
  `;As([Q({type:String})],li.prototype,"mac",2);As([Q({type:Boolean})],li.prototype,"visible",2);As([Q({type:Boolean})],li.prototype,"stopped",2);As([v()],li.prototype,"logs",2);As([v()],li.prototype,"autoScroll",2);li=As([we("esp-compile-log-viewer")],li);var qg=Object.defineProperty,Vg=Object.getOwnPropertyDescriptor,bt=(t,e,i,s)=>{for(var r=s>1?void 0:s?Vg(e,i):e,n=t.length-1,o;n>=0;n--)(o=t[n])&&(r=(s?o(e,i,r):o(r))||r);return s&&r&&qg(e,i,r),r};const Qg=["queued","starting","transferring","verifying","transfer_success_waiting_rejoin"],wo=["compile_queued","compiling"];let et=class extends ce{constructor(){super(...arguments),this.mac="",this.node=null,this.topology=[],this.currentJob=null,this.history=[],this.compileHistoryList=[],this.compileStatus="idle",this.loading=!0,this.error="",this.compileTimer=null}connectedCallback(){super.connectedCallback(),this.load(),this.schedulePoll()}disconnectedCallback(){this.timer&&window.clearInterval(this.timer),this.compileTimer&&window.clearInterval(this.compileTimer),super.disconnectedCallback()}schedulePoll(){this.timer&&window.clearInterval(this.timer);const e=this.currentJob&&Qg.includes(this.currentJob.status)?2e3:5e3;this.timer=window.setInterval(()=>void this.load(!1),e)}pollCompileStatus(){S.getCompileStatus(this.mac).then(t=>{this.compileStatus=t.status,wo.includes(t.status)?this.compileTimer||(this.compileTimer=setInterval(()=>this.pollCompileStatus(),3e3)):this.compileTimer&&(clearInterval(this.compileTimer),this.compileTimer=null)}).catch(()=>{})}handleReflashResult(t){this.otaBox.preflight=t.detail.preflight,this.load(!1)}updated(){this.schedulePoll()}async load(t=!0){t&&(this.loading=!0);try{const[e,i,s,r,n]=await Promise.all([S.topology(),S.currentOtaForDevice(this.mac),S.getQueue(),S.history(this.mac),S.getCompileHistory(this.mac)]);this.topology=e,this.node=e.find(c=>le(c.mac)===le(this.mac))||null;const o=le(this.mac),a=(s.queued_jobs??[]).find(c=>le(c.mac)===o)??null;i&&i.job&&le(i.job.mac)===o?this.currentJob=i.job:a?this.currentJob=a:this.currentJob=null,this.history=r.jobs,this.compileHistoryList=n.jobs,this.error="";const l=await S.getCompileStatus(this.mac).catch(()=>null);l&&(this.compileStatus=l.status),wo.includes(this.compileStatus)&&this.pollCompileStatus()}catch(e){this.error=e instanceof Error?e.message:String(e)}finally{this.loading=!1}}goBack(){window.location.hash="/"}render(){if(this.loading)return g`<div class="card">Loading device...</div>`;if(this.error)return g`<div class="card error">${this.error}</div>`;if(!this.node)return g`
        <div class="card">
      ...
      <section class="hero">
        <div class="hero-left">
          ...
          <div class="hero-stats">
            ...
            <div class="hero-box sm"><span class="lbl">Uptime</span><span class="val">${ut(this.node.uptime_s)}</span></div>
            <div class="hero-box sm"><span class="lbl">Last Seen</span><span class="val">${this.node.last_seen_ago!=null?`${ut(this.node.last_seen_ago)}${this.node.is_bridge?"":" ago"}`:"-"}</span></div>
...
.hero-box.sm .val {
  ...
  `;ne([Q({type:Boolean})],te.prototype,"autoInit",2);ne([v()],te.prototype,"config",2);ne([v()],te.prototype,"configuredBridges",2);ne([v()],te.prototype,"discoveredBridges",2);ne([v()],te.prototype,"loading",2);ne([v()],te.prototype,"discovering",2);ne([v()],te.prototype,"saving",2);ne([v()],te.prototype,"error",2);ne([v()],te.prototype,"saved",2);ne([v()],te.prototype,"containerStatus",2);ne([v()],te.prototype,"cleaningArtifacts",2);ne([v()],te.prototype,"artifactsMessage",2);ne([v()],te.prototype,"editingBridgeId",2);ne([v()],te.prototype,"editApiKey",2);ne([v()],te.prototype,"newBridgeApiKey",2);ne([v()],te.prototype,"showManualEntry",2);ne([v()],te.prototype,"manualHost",2);ne([v()],te.prototype,"manualPort",2);ne([v()],te.prototype,"manualApiKey",2);ne([v()],te.prototype,"showScanLog",2);ne([v()],te.prototype,"scanLogContent",2);ne([v()],te.prototype,"scanLogLoading",2);ne([v()],te.prototype,"restarting",2);ne([v()],te.prototype,"restartFeedback",2);te=ne([we("esp-settings")],te);var Xg=Object.defineProperty,Jg=Object.getOwnPropertyDescriptor,Lt=(t,e,i,s)=>{for(var r=s>1?void 0:s?Jg(e,i):e,n=t.length-1,o;n>=0;n--)(o=t[n])&&(r=(s?o(e,i,r):o(r))||r);return s&&r&&Xg(e,i,r),r};const Yg=300,pc=new Set(["success","failed","aborted","rejoin_timeout","version_mismatch"]);let at=class extends ce{constructor(){super(...arguments),this.queueData=null,this.compileData=null,this.historyJobs=[],this.error="",this.busyJob=null,this.busyAction="",this.showAbortModal=!1,this.historyFilter="all",this.historyLimit=10,this.pollTimer=null,this.historyTimer=null}connectedCallback(){super.connectedCallback(),this.fetchQueue(),this.pollTimer=setInterval(()=>this.fetchQueue(),2e3),this.fetchHistory(),this.historyTimer=setInterval(()=>this.fetchHistory(),5e3)}disconnectedCallback(){this.pollTimer&&(clearInterval(this.pollTimer),this.pollTimer=null),this.historyTimer&&(clearInterval(this.historyTimer),this.historyTimer=null),super.disconnectedCallback()}async fetchQueue(){try{const[t,e]=await Promise.all([S.getQueue(),S.getCompileQueue()]);this.queueData=t,this.compileData=e}catch{}}async fetchHistory(){try{const t=await S.getAllHistory(100);this.historyJobs=t.jobs}catch{}}async pauseQueue(){this.busyAction="pause",this.error="";try{await S.pauseQueue(),await this.fetchQueue()}catch(t){this.error=t instanceof Error?t.message:String(t)}finally{this.busyAction=""}}async resumeQueue(){this.busyAction="resume",this.error="";try{await S.resumeQueue(),await this.fetchQueue()}catch(t){this.error=t instanceof Error?t.message:String(t)}finally{this.busyAction=""}}async abortQueuedJob(t){this.busyJob=t,this.error="";try{await S.abortQueuedJob(t),await this.fetchQueue()}catch(e){this.error=e instanceof Error?e.message:String(e)}finally{this.busyJob=null}}async abortCompileJob(t){this.busyJob=t,this.error="";try{await S.abortCompileJob(t),await this.fetchQueue()}catch(e){this.error=e instanceof Error?e.message:String(e)}finally{this.busyJob=null}}async moveUp(t){this.busyJob=t,this.error="";try{await S.reorderJobUp(t),await this.fetchQueue()}catch(e){this.error=e instanceof Error?e.message:String(e)}finally{this.busyJob=null}}async moveDown(t){this.busyJob=t,this.error="";try{await S.reorderJobDown(t),await this.fetchQueue()}catch(e){this.error=e instanceof Error?e.message:String(e)}finally{this.busyJob=null}}async abortActiveJob(){this.busyAction="abort-active",this.error="";try{if((await S.getQueue()).count>0){this.showAbortModal=!0;return}await S.abortOta(),await this.fetchQueue()}catch(t){this.error=t instanceof Error?t.message:String(t)}finally{this.busyAction=""}}async abortActiveAndContinue(){this.showAbortModal=!1;try{await S.abortOta(),await this.fetchQueue()}catch(t){this.error=t instanceof Error?t.message:String(t)}}async abortActiveAndPause(){this.showAbortModal=!1;try{await S.abortOta(),await S.pauseQueue(),await this.fetchQueue()}catch(t){this.error=t instanceof Error?t.message:String(t)}}navigateToDevice(t){window.location.hash=`/device/${encodeURIComponent(t)}`}navigateToJob(t){window.location.hash=`/job/${t.id}?from=${encodeURIComponent("/queue")}`}labelFor(t){return t.device_label||t.parsed_esphome_name||t.esphome_name||t.mac}buildDisplayEntries(){const e=[...this.historyJobs.filter(s=>this.historyFilter==="all"?!0:(s.job_type||this.inferJobType(s))===this.historyFilter)].sort((s,r)=>(s.created_at??0)-(r.created_at??0)),i=[];for(let s=0;s<e.length;s++){const r=e[s],n=e[s+1],o=r.job_type||this.inferJobType(r);if(n&&o==="compile"&&(n.job_type||this.inferJobType(n))==="flash"&&r.mac===n.mac&&n.created_at-r.created_at<=Yg){const a=n.status==="success"&&r.status==="compile_success"?"success":"failed";i.push({type:"combined",compileJob:r,flashJob:n,label:this.labelFor(r),status:a,statusLabel:a==="success"?"Success":"Failed",created_at:n.created_at}),s++}else i.push({type:o,job:r,label:this.labelFor(r),status:r.status,statusLabel:r.status==="success"&&o==="flash"?"OTA Upload Success":r.status.replaceAll("_"," "),created_at:r.created_at})}return i.sort((s,r)=>r.created_at-s.created_at),i}inferJobType(t){return t.status==="compile_success"||t.status==="compile_queued"||t.status==="compiling"?"compile":(pc.has(t.status),"flash")}get statusStyles(){return{success:"background:#dcfce7;color:#15803d;",failed:"background:#fef2f2;color:#dc2626;",aborted:"background:#fef3c7;color:#b45309;",rejoin_timeout:"background:#fef3c7;color:#b45309;",version_mismatch:"background:#fef3c7;color:#b45309;",compile_success:"background:#dcfce7;color:#15803d;"}}render(){var d,f,u;const t=this.queueData,e=!!(t!=null&&t.active_job)&&!pc.has(t.active_job.status),i=(t==null?void 0:t.queued_jobs)??[],s=(t==null?void 0:t.paused)??!1,r=i.length+(e?1:0),n=((d=this.compileData)==null?void 0:d.active_job)??null,o=((f=this.compileData)==null?void 0:f.queued_jobs)??[],a=((u=this.compileData)==null?void 0:u.count)??0,l=this.buildDisplayEntries(),c=l.slice(0,this.historyLimit),h=l.length;return g`
    ...
    `}renderHistoryRow(t){const e=t.job,i=this.statusStyles[t.status]||"",s=e.completed_at&&e.started_at?ut(e.completed_at-e.started_at):"";return g`
    ...
    `}renderCombinedRow(t){const e=t.compileJob,i=t.flashJob,s=e.completed_at&&e.started_at?ut(e.completed_at-e.started_at):"",r=i.completed_at&&i.started_at?ut(i.completed_at-i.started_at):"",n=this.statusStyles[t.status]||"";return g`
...
`)}findBlockEnd(t,e,i=0){const s=t.findIndex((n,o)=>o>=i&&e.test(n));if(s<0)return-1;let r=s+1;for(;r<t.length&&(t[r].startsWith(" ")||t[r].startsWith("	"));)r++;return r}async applyExternalComponentsFix(){this.showExternalComponentsFix=!1,this.insertExternalComponentsFix(),this.yamlWarnings=[],this.hasUnsavedChanges=!0,this.requestUpdate();const t=this.pendingAction,e=this.pendingAutoFlash;this.pendingAction=null,this.pendingAutoFlash=!1,t==="save"?await this.saveConfig(!0):t==="compile"&&await this.queueCompile(e,!0)}async dismissExternalComponentsFix(){this.showExternalComponentsFix=!1;const t=this.pendingAction,e=this.pendingAutoFlash;this.pendingAction=null,this.pendingAutoFlash=!1,t==="save"?await this.saveConfig(!0):t==="compile"&&await this.queueCompile(e,!0)}async dismissSecretsWarning(){this.showSecretsWarning=!1;const t=this.pendingAction,e=this.pendingAutoFlash;this.pendingAction=null,this.pendingAutoFlash=!1,t==="compile"&&await this.queueCompile(e,!0)}goToSecretsFromWarning(){this.showSecretsWarning=!1,this.goToSecrets()}async checkForMissingSecrets(){try{return(await S.checkSecrets(this.editorContent)).missing_secrets}catch{return[]}}async queueCompile(t,e=!1){if(!(this.compilePhase==="compiling"||this.compilePhase==="compile_queued")){if(!e){const i=await this.checkForMissingSecrets();if(i.length>0){this.missingSecrets=i,this.pendingAction="compile",this.pendingAutoFlash=t,this.showSecretsWarning=!0;return}}if(!e&&!il(this.editorContent)){this.pendingAction="compile",this.pendingAutoFlash=t,this.showExternalComponentsFix=!0;return}this.hasUnsavedChanges&&await this.saveConfig(!0),this.compilePhase="compiling",this.compileStartedAt=Date.now(),this.startElapsedTimer(),this.error="",this.showCompileLog=!0;try{const i=await S.compileDevice(this.mac,t);this.compileJobId=i.job.id,this.preflight=i.preflight||null,i.job.status==="compile_queued"?(this.compilePhase="compile_queued",this.compileQueuePosition=i.queue_position):i.job.status==="compiling"&&(this.compilePhase="compiling",this.compileQueuePosition=null),this.startPolling()}catch(i){this.compilePhase="failed",this.compileStartedAt=null,this.stopElapsedTimer(),this.error=i instanceof Error?i.message:String(i)}}}async triggerCompile(){this.flashIntent="none",await this.queueCompile(!1)}async triggerOtaFlash(){this.flashIntent="ota",await this.queueCompile(!0)}async triggerBrowserFlashFlow(){this.flashIntent="browser",await this.queueCompile(!1)}async cancelCompile(){try{await S.cancelCompile(this.mac)}catch{}this.compilePhase="idle",this.compileJobId=null,this.compileQueuePosition=null,this.compileStartedAt=null,this.flashIntent="none",this.clearBrowserFlashManifestUrl(),this.stopElapsedTimer(),this.stopPolling()}goBack(){window.location.hash=`/device/${encodeURIComponent(this.mac)}`}goToTopology(){window.location.hash="/"}goToSecrets(){window.location.hash=`/secrets?from=${encodeURIComponent(window.location.hash)}`}updated(t){(t.has("compilePhase")||t.has("device")||t.has("preflight"))&&this.updateBrowserFlashManifestUrl()}render(){var c,h,d,f,u;const t=String(((c=this.device)==null?void 0:c.esphome_name)||((h=this.device)==null?void 0:h.label)||this.mac),e=String(((d=this.device)==null?void 0:d.chip_name)||"-"),i=this.topology.find(p=>le(p.mac)===le(this.mac)),s=(i==null?void 0:i.online)??!!((f=this.device)!=null&&f.online),r=this.device,o=!!!(r!=null&&r.is_bridge)&&((r==null?void 0:r.hops)??0)>0,a=this.browserFlashChipFamily,l=this.compilePhase==="compiled"&&!!this.browserFlashManifestUrl;return g`
  ...
  `;ae([Q({type:String})],re.prototype,"mac",2);ae([v()],re.prototype,"state",2);ae([v()],re.prototype,"device",2);ae([v()],re.prototype,"config",2);ae([v()],re.prototype,"editorContent",2);ae([v()],re.prototype,"saveIndicator",2);ae([v()],re.prototype,"hasUnsavedChanges",2);ae([v()],re.prototype,"error",2);ae([v()],re.prototype,"compilePhase",2);ae([v()],re.prototype,"topology",2);ae([v()],re.prototype,"compileJobId",2);ae([v()],re.prototype,"compileQueuePosition",2);ae([v()],re.prototype,"preflight",2);ae([v()],re.prototype,"chipUnknown",2);ae([v()],re.prototype,"yamlWarnings",2);ae([v()],re.prototype,"showExternalComponentsFix",2);ae([v()],re.prototype,"showSecretsWarning",2);ae([v()],re.prototype,"missingSecrets",2);ae([v()],re.prototype,"showCompileLog",2);ae([v()],re.prototype,"compileStartedAt",2);ae([v()],re.prototype,"flashIntent",2);ae([v()],re.prototype,"browserFlashManifestUrl",2);ae([Pd("esp-compile-log-viewer")],re.prototype,"compileLogViewer",2);re=ae([we("esp-config-page")],re);var ak=Object.defineProperty,lk=Object.getOwnPropertyDescriptor,Ms=(t,e,i,s)=>{for(var r=s>1?void 0:s?lk(e,i):e,n=t.length-1,o;n>=0;n--)(o=t[n])&&(r=(s?o(e,i,r):o(r))||r);return s&&r&&ak(e,i,r),r};let mi=class extends ce{constructor(){super(...arguments),this.from="/",this.content="",this.saved=!1,this.loading=!0,this.error=""}connectedCallback(){super.connectedCallback(),this.load()}async load(){this.loading=!0;try{const t=await S.getSecrets();this.content=t.content,this.error=""}catch(t){this.error=t instanceof Error?t.message:String(t)}finally{this.loading=!1}}async save(){this.saved=!1;try{await S.saveSecrets(this.content),this.saved=!0,this.error="",setTimeout(()=>{this.saved=!1,this.requestUpdate()},2e3)}catch(t){this.error=t instanceof Error?t.message:String(t)}}onInput(t){this.content=t.target.value}goBack(){window.location.hash=this.from}render(){const t=this.from==="/"?"topology":"device config";return g`
  ...
  `;Ms([Q({type:String})],mi.prototype,"from",2);Ms([v()],mi.prototype,"content",2);Ms([v()],mi.prototype,"saved",2);Ms([v()],mi.prototype,"loading",2);Ms([v()],mi.prototype,"error",2);mi=Ms([we("esp-secrets-page")],mi);var ck=Object.defineProperty,hk=Object.getOwnPropertyDescriptor,wi=(t,e,i,s)=>{for(var r=s>1?void 0:s?hk(e,i):e,n=t.length-1,o;n>=0;n--)(o=t[n])&&(r=(s?o(e,i,r):o(r))||r);return s&&r&&ck(e,i,r),r};const dk={compile_queued:"Queued for compile",compiling:"Compiling",compile_success:"Compile success",queued:"Queued for flash",starting:"Starting",announcing:"Waiting for device accept",transferring:"Transferring",verifying:"Verifying",transfer_success_waiting_rejoin:"Waiting for device rejoin",success:"Success",failed:"Failed",aborted:"Aborted",rejoin_timeout:"Rejoin timeout",version_mismatch:"Version mismatch"},fk={compile_queued:"⚙",compile_dequeued:"⚙",compiling:"⚙",compile_success:"✅",compile_failed:"❌",compile_output:"📋",compile_cancelled:"❌",flash_queued:"📦",flash_dequeued:"📦",flash_starting:"▶",flash_announcing:"⏳",flash_transferring:"📤",flash_progress:"📈",flash_verifying:"✅",flash_rejoin_waiting:"⏳",flash_rejoined:"🔄",flash_version_mismatch:"⚠",flash_rejoin_timeout:"⏰",flash_success:"✅",flash_failed:"❌",flash_aborted:"🛑",flash_start_failed:"❌",dequeue_retry:"🔄",dequeue_moved_back:"🔄",ota_start_retry:"🔄"},uk=["compile_success","success","failed","aborted","rejoin_timeout","version_mismatch"];let Rt=class extends ce{constructor(){super(...arguments),this.jobId=0,this.from="/queue",this.job=null,this.logData=null,this.error="",this.loading=!0,this.expandedOutput=new Set,this.pollTimer=null}connectedCallback(){super.connectedCallback()}disconnectedCallback(){this.stopPolling(),super.disconnectedCallback()}updated(t){t.has("jobId")&&this.jobId&&(this.loading=!0,this.error="",this.fetchLog())}startPolling(){this.pollTimer||(this.pollTimer=setInterval(()=>this.fetchLog(),2e3))}stopPolling(){this.pollTimer&&(clearInterval(this.pollTimer),this.pollTimer=null)}async fetchJob(){var t;if(this.jobId)try{const e=(t=this.logData)==null?void 0:t.mac;if(e){const s=(await S.history(e)).jobs.find(r=>r.id===this.jobId);this.job=s||null}}catch{}}async fetchLog(){var t,e;if(this.jobId)try{this.logData=await S.jobLog(this.jobId),this.loading=!1,!this.job&&((t=this.logData)!=null&&t.mac)&&await this.fetchJob(),(e=this.logData)!=null&&e.is_terminal?this.stopPolling():this.startPolling()}catch(i){this.error=i instanceof Error?i.message:String(i),this.loading=!1,this.stopPolling()}}toggleOutput(t){const e=new Set(this.expandedOutput);e.has(t)?e.delete(t):e.add(t),this.expandedOutput=e}formatEventTime(t){return new Date(t*1e3).toLocaleTimeString()}renderEvent(t,e){const i=fk[t.type]||"•",s=this.formatEventTime(t.ts),r=t.type==="compile_output",n=this.expandedOutput.has(e),a={compile_success:"ok",flash_success:"ok",compile_failed:"danger",flash_failed:"danger",flash_aborted:"danger",flash_version_mismatch:"warn",flash_rejoin_timeout:"warn"}[t.type]||"";return g`
      <div class="event ${r?"event-output":""} ${a}">
        <div class="event-header" @click=${r?(()=>this.toggleOutput(e)):void 0}>
          ...
          ${t.duration_s!=null?g`<span class="event-detail">took ${ut(t.duration_s)}</span>`:y}
          ...
          <div class="meta">
            ...
            ${e.started_at&&e.completed_at?g`
              <div class="meta-item">
                ...
                <span>${ut(e.completed_at-e.started_at)}</span>
              </div>
            `:y}
            ${e.error_msg?g`
...
`}))}get flashCompileStatusLabel(){return{idle:"Waiting to start...",compile_queued:"Queued for compilation...",compiling:"Compiling...",compiled:"Compile complete!",failed:"Compilation failed"}[this.flashCompileStatus]||this.flashCompileStatus}async scanFlashSerialPorts(){this.flashSerialPortScanning=!0;try{const t=await S.scanSerialPorts();this.flashSerialPorts=t,t.length===0&&(this.flashSerialFlashError="No serial ports found on the add-on host.")}catch(t){this.flashSerialFlashError=t instanceof Error?t.message:String(t)}finally{this.flashSerialPortScanning=!1}}async startSerialFlashFromWizard(){if(!(!this.flashMac||!this.flashSerialPort)){this.flashSerialFlashError="",this.flashSerialFlashStatus="flashing";try{await S.startSerialFlash(this.flashMac,this.flashSerialPort)}catch(t){this.flashSerialFlashError=t instanceof Error?t.message:String(t),this.flashSerialFlashStatus="failed";return}this.flashSerialFlashTimer=setInterval(()=>void this.pollSerialFlashStatus(),2e3)}}async pollSerialFlashStatus(){if(this.flashMac)try{const t=await S.getSerialFlashStatus(this.flashMac),e=t.status||"idle";this.flashSerialFlashStatus=e,(e==="success"||e==="failed")&&(this.flashSerialFlashTimer&&(clearInterval(this.flashSerialFlashTimer),this.flashSerialFlashTimer=null),e==="failed"&&(this.flashSerialFlashError=t.error||"Serial flash failed"))}catch{}}async startDetection(){if(this.flashStage="detecting",this.flashDetectElapsed=0,this.flashDetectError="",this.flashTransport==="serial")try{await S.finalizeFlashWizard()}catch{}else await S.triggerScan().catch(()=>{});this.flashDetectTimer=setInterval(()=>void this.pollFlashWizardStatus(),2e3)}async pollFlashWizardStatus(){if(this.flashStage!=="detecting"){this.flashDetectTimer&&(clearInterval(this.flashDetectTimer),this.flashDetectTimer=null);return}if(this.flashDetectElapsed+=2,this.flashDetectElapsed>=90){this.flashDetectTimer&&(clearInterval(this.flashDetectTimer),this.flashDetectTimer=null),this.flashDetectError=this.flashTransport==="serial"?"Bridge did not authenticate over serial within 90 seconds. Check the port is correct and the bridge is powered.":"Bridge not found within 90 seconds. Ensure the bridge is powered on and connected to WiFi.",this.flashStage="error";return}try{(await S.getFlashWizardStatus()).bridge_detected&&(this.flashDetectTimer&&(clearInterval(this.flashDetectTimer),this.flashDetectTimer=null),this.flashStage="complete",this.step1="complete",this.step2="ready",this.pollStatus())}catch{}}get flashBackLabel(){return this.flashStage==="detecting"||this.flashStage==="error"&&this.flashDetectError?"← Back to Flash":this.flashStage==="flashing"||this.flashStage==="compiling"||this.flashStage==="error"?"← Back to Configure":"← Back"}async handleFlashBack(){if(this.flashStage==="detecting"||this.flashStage==="error"&&this.flashDetectError){this.flashDetectTimer&&(clearInterval(this.flashDetectTimer),this.flashDetectTimer=null),this.flashDetectElapsed=0,this.flashDetectError="",this.flashStage="flashing";return}if(this.flashStage==="flashing"||this.flashStage==="error"){this.resetFlashWizard();return}if(this.flashStage==="compiling"){this.flashMac&&await S.cancelCompile(this.flashMac).catch(()=>{}),this.resetFlashWizard();return}this.onBackToChoose()}resetFlashWizard(){this.cleanupFlashTimers(),this.flashStage="config",this.flashCompileLog="",this.flashCompilePercent=0,this.flashCompileStatus="",this.flashCompileError="",this.flashFlashError="",this.flashDetectElapsed=0,this.flashDetectError="",this.flashMac="",this.flashConfigError=""}cleanupFlashTimers(){this.flashCompilePollTimer&&(clearInterval(this.flashCompilePollTimer),this.flashCompilePollTimer=null),this.flashDetectTimer&&(clearInterval(this.flashDetectTimer),this.flashDetectTimer=null),this.flashCompileLogEs&&(this.flashCompileLogEs.close(),this.flashCompileLogEs=null),this.clearFlashBrowserManifestUrl()}render(){return g`
    ...
    `}};E.MAX_POLL_DURATION_MS=300*1e3;E.MAX_DISCOVERY_DURATION_MS=30*1e3;E.STATUS_POLL_INTERVAL_MS=1e3;E.STATUS_POLL_INTERVAL_S=E.STATUS_POLL_INTERVAL_MS/1e3;E.styles=xe`
    :host {
      --bg: #f5f7fa;
      --surface: #ffffff;
      --ink: #1c1c1e;
  ...
  `;L([v()],E.prototype,"step1",2);L([v()],E.prototype,"step1Choice",2);L([v()],E.prototype,"step2",2);L([v()],E.prototype,"step3",2);L([v()],E.prototype,"discoveredBridges",2);L([v()],E.prototype,"bridgeError",2);L([v()],E.prototype,"manualHost",2);L([v()],E.prototype,"manualPort",2);L([v()],E.prototype,"manualApiKey",2);L([v()],E.prototype,"apiKeyInput",2);L([v()],E.prototype,"selectedBridge",2);L([v()],E.prototype,"restartError",2);L([v()],E.prototype,"integrationError",2);L([v()],E.prototype,"runningIntegrationVersion",2);L([v()],E.prototype,"latestIntegrationVersion",2);L([v()],E.prototype,"integrationDetected",2);L([v()],E.prototype,"bridgeApiStatus",2);L([v()],E.prototype,"statusPollTimer",2);L([v()],E.prototype,"integrationPollTimer",2);L([v()],E.prototype,"integrationFailures",2);L([v()],E.prototype,"pollingSeconds",2);L([v()],E.prototype,"flashTab",2);L([v()],E.prototype,"flashStage",2);L([v()],E.prototype,"flashName",2);L([v()],E.prototype,"flashNetworkId",2);L([v()],E.prototype,"flashPsk",2);L([v()],E.prototype,"flashWifiSsid",2);L([v()],E.prototype,"flashWifiPassword",2);L([v()],E.prototype,"flashApiKey",2);L([v()],E.prototype,"flashEspnowMode",2);L([v()],E.prototype,"flashOtaPassword",2);L([v()],E.prototype,"flashChipName",2);L([v()],E.prototype,"flashTransport",2);L([v()],E.prototype,"flashSerialPort",2);L([v()],E.prototype,"flashSerialPorts",2);L([v()],E.prototype,"flashSerialPortScanning",2);L([v()],E.prototype,"flashSerialFlashStatus",2);L([v()],E.prototype,"flashSerialFlashError",2);L([v()],E.prototype,"flashBoardInfo",2);L([v()],E.prototype,"flashBrowserDetecting",2);L([v()],E.prototype,"flashBrowserDetectError",2);L([v()],E.prototype,"flashDetectedChip",2);L([v()],E.prototype,"flashSecretsWarning",2);L([v()],E.prototype,"flashConfigError",2);L([v()],E.prototype,"flashMac",2);L([v()],E.prototype,"flashCompileLog",2);L([v()],E.prototype,"flashCompilePercent",2);L([v()],E.prototype,"flashCompileStatus",2);L([v()],E.prototype,"flashCompileError",2);L([v()],E.prototype,"flashFlashError",2);L([v()],E.prototype,"flashDetectElapsed",2);L([v()],E.prototype,"flashDetectError",2);L([v()],E.prototype,"flashBrowserManifestUrl",2);L([v()],E.prototype,"serialPorts",2);L([v()],E.prototype,"serialScanning",2);L([v()],E.prototype,"serialSelectedPort",2);L([v()],E.prototype,"serialBaud",2);L([v()],E.prototype,"serialApiKey",2);L([v()],E.prototype,"serialName",2);L([v()],E.prototype,"serialError",2);E=L([we("esp-setup-wizard")],E);var oC=Object.defineProperty,aC=Object.getOwnPropertyDescriptor,Ce=(t,e,i,s)=>{for(var r=s>1?void 0:s?aC(e,i):e,n=t.length-1,o;n>=0;n--)(o=t[n])&&(r=(s?o(e,i,r):o(r))||r);return s&&r&&oC(e,i,r),r};let me=class extends ce{constructor(){super(...arguments),this.name="espnow-remote",this.networkId="",this.psk="",this.ports=[],this.selectedPort="",this.scanningPorts=!1,this.chipName="",this.boardInfo=null,this.detecting=!1,this.stage="config",this.error="",this.mac="",this.esphomeName="",this.compilePercent=0,this.flashStatus="",this.flashLog=[],this.secretsLoaded=!1,this.pollTimer=null}connectedCallback(){super.connectedCallback(),this.loadDefaults()}disconnectedCallback(){this.clearPoll(),super.disconnectedCallback()}clearPoll(){this.pollTimer&&(clearInterval(this.pollTimer),this.pollTimer=null)}async loadDefaults(){try{const{content:t}=await S.getSecrets(),e=i=>{const s=t.match(new RegExp(`^\\s*${i}\\s*:\\s*(.+)$`,"m"));return s?s[1].trim().replace(/^["']|["']$/g,""):""};this.networkId=this.networkId||e("espnow_network_id"),this.psk=this.psk||e("espnow_psk"),this.secretsLoaded=!0}catch{}}async scanPorts(){this.scanningPorts=!0;try{const t=await S.getSerialPorts();this.ports=t.ports??[];const e=this.ports.filter(i=>i.available);!this.selectedPort&&e.length>0&&(this.selectedPort=e[0].port)}catch(t){this.error=t instanceof Error?t.message:String(t)}finally{this.scanningPorts=!1}}async detectChip(){if(this.selectedPort){this.detecting=!0,this.error="";try{const t=await S.detectChip(this.selectedPort);if(t.error||!t.board_info){this.chipName=t.chip_name||"unknown",this.boardInfo=null,this.error=t.error||`chip '${t.chip_name}' is not a supported board`;return}this.chipName=t.chip_name,this.boardInfo=t.board_info}catch(t){this.error=t instanceof Error?t.message:String(t)}finally{this.detecting=!1}}}canSubmit(){return!!(this.name.trim()&&this.boardInfo&&this.chipName&&this.networkId.trim()&&this.psk.trim())}async submit(){if(!(!this.canSubmit()||!this.boardInfo)){this.error="",this.stage="compiling",this.compilePercent=0;try{const t=await S.submitFlashWizard({name:this.name.trim(),network_id:this.networkId.trim(),psk:this.psk.trim(),wifi_ssid:"",wifi_password:"",api_key:"",espnow_mode:"lr",ota_password:"",chip_name:this.chipName,board_info:this.boardInfo,transport:"espnow",kind:"remote"});this.mac=t.mac,this.esphomeName=t.esphome_name,this.startCompilePoll()}catch(t){this.error=t instanceof Error?t.message:String(t),this.stage="error"}}}startCompilePoll(){this.clearPoll(),this.pollTimer=setInterval(()=>{this.pollCompile()},3e3),this.pollCompile()}async pollCompile(){try{const t=await S.getFlashWizardStatus(),e=t.compile_status??"idle";if(typeof t.percent=="number"&&(this.compilePercent=t.percent),e==="compile_success"||e==="success"){this.clearPoll(),this.stage="ready";return}["failed","compile_failed","aborted","rejoin_timeout","version_mismatch"].includes(e)&&(this.clearPoll(),this.error=`Compile finished as "${e}" — check the queue page for the build log.`,this.stage="error")}catch{}}async startFlash(){if(!(!this.selectedPort||!this.mac)){this.stage="flashing",this.flashStatus="starting",this.flashLog=[];try{await S.startSerialFlash(this.mac,this.selectedPort);const t=S.streamSerialFlashLogs(this.mac,e=>{this.flashLog=[...this.flashLog.slice(-200),e]},e=>{this.flashStatus=e,e==="success"?this.finish():e==="failed"&&(this.error="Serial flash failed — see the log below.",this.stage="error",t.close())},()=>{})}catch(t){this.error=t instanceof Error?t.message:String(t),this.stage="error"}}}async finish(){this.clearPoll();try{await S.finalizeFlashWizard()}catch{}this.stage="done"}goTopology(){window.location.hash="/"}render(){const t=this.ports.filter(e=>e.available);return g`
      <section class="card">
        <div class="card-header">
          <h2>Create Remote</h2>
        ...
        <div class="card-body">
                ...
                <label class="field">
                  ...
                  <div class="row">
                    <select
                      ...
                      @change=${e=>{this.selectedPort=e.target.value}}
                    >
                      <option value="">— select a port —</option>
                      ${t.map(e=>g`<option value=${e.port} ?selected=${e.port===this.selectedPort}>${e.label||e.port}</option>`)}
                    </select>
                  ...
                  ${this.chipName?g`<small class="ok-note">Detected: ${this.chipName}${this.boardInfo?` (${this.boardInfo.board})`:""}</small>`:y}
                </label>
                ...
                <details class="advanced" ?open=${!this.secretsLoaded}>
                  ...
                  <label class="field">
                    ...
                    <input
                      ...
                      @input=${e=>{this.networkId=e.target.value}}
                    />
                  </label>
                  <label class="field">
                    ...
                    <input
                      type="text"
                      .value=${this.psk}
                      @input=${e=>{this.psk=e.target.value}}
                    />
                  </label>
          ...
          ${this.stage==="ready"?g`
                ...
                ${this.selectedPort?y:g`<p class="hint">Select a serial port first.</p>`}
              `:y}

          ${this.stage==="flashing"?g`
                <div class="status">
                  <div class="spinner"></div>
                  <div>
...
.badge.loading {
  ...
  `;Ft([v()],lt.prototype,"route",2);Ft([v()],lt.prototype,"queueData",2);Ft([v()],lt.prototype,"compileData",2);Ft([v()],lt.prototype,"addonConnected",2);Ft([v()],lt.prototype,"bridgeConnected",2);Ft([v()],lt.prototype,"bridgeConfigured",2);Ft([v()],lt.prototype,"integrationLoaded",2);Ft([v()],lt.prototype,"integrationConfigured",2);Ft([v()],lt.prototype,"restartRequired",2);lt=Ft([we("espnow-app")],lt);
//# sourceMappingURL=index-CDAtMz2M.js.map
